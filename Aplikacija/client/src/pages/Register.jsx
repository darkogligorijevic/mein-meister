    ...
    <div className="h-screen md:flex">
      ...
      <div className="flex md:w-1/2 justify-center py-10 items-center bg-white">
        <form className="bg-white">
          <h1 className="text-gray-800 font-bold text-2xl lg:text-4xl mb-2">Registracija</h1>
          ...
          <div className='flex justify-between gap-4'>
            <div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
              ...
              <input onChange={handleChange} className="pl-2 outline-none border-none" type="text" name='firstName' placeholder='Ime' />
            </div>
            <div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
              ...
              <input onChange={handleChange} className="pl-2 outline-none border-none" type="text" name='lastName' placeholder='Prezime' />
          </div>
          </div>
              <div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" fill="none"
                ...
                <input onChange={handleChange} className="pl-2 outline-none w-full border-none" name='email' type='email' placeholder='E-mail' />
          </div>
